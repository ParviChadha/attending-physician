...
`;function Hf(){return s.jsxs(s.Fragment,{children:[s.jsx("style",{dangerouslySetInnerHTML:{__html:ox}}),s.jsx(rx,{})]})}function cx(){return s.jsxs(Ay,{children:[s.jsx(Ci,{path:"/",element:s.jsx(Hf,{})}),s.jsx(Ci,{path:"/chat",element:s.jsx(W1,{})}),s.jsx(Ci,{path:"*",element:s.jsx(Hf,{})})]})}Dp.createRoot(document.getElementById("root")).render(s.jsx(y.StrictMode,{children:s.jsx(Ry,{children:s.jsx(cx,{})})}));
